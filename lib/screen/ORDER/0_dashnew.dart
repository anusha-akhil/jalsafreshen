...
import 'package:jalsafreshen/components/commoncolor.dart';
import 'package:jalsafreshen/components/customToast.dart';
import 'package:jalsafreshen/components/network_connectivity.dart';
import 'package:jalsafreshen/components/noNetwork.dart';
import 'package:jalsafreshen/components/unregister_popup.dart';
import 'package:jalsafreshen/controller/controller.dart';
import 'package:jalsafreshen/db_helper.dart';
import 'package:jalsafreshen/screen/ADMIN_/admin_dashboard.dart';
import 'package:jalsafreshen/screen/ADMIN_/homePage.dart';
import 'package:jalsafreshen/screen/ORDER/2_companyDetailsscreen.dart';
import 'package:jalsafreshen/screen/ORDER/3_staffLoginScreen.dart';
import 'package:jalsafreshen/screen/ORDER/5_mainDashboard.dart';
import 'package:jalsafreshen/screen/ORDER/6_customer_creation.dart';
import 'package:jalsafreshen/screen/ORDER/6_downloadedPage.dart';
import 'package:jalsafreshen/screen/ORDER/6_historypage.dart';
import 'package:jalsafreshen/screen/ORDER/6_reportPage.dart';
import 'package:jalsafreshen/screen/ORDER/6_uploaddata.dart';
import 'package:jalsafreshen/screen/ORDER/todayCollection.dart';
import 'package:jalsafreshen/screen/ORDER/todaySale.dart';
import 'package:jalsafreshen/screen/ORDER/todaysOrder.dart';
import 'package:jalsafreshen/screen/ORDER/webview.dart';
import 'package:jalsafreshen/screen/reports/sale_report.dart';
import 'package:provider/provider.dart';
import 'package:jalsafreshen/service/queryResult.dart';
import 'package:jalsafreshen/service/tableList.dart';
  ...
  _getDrawerItemWidget(String? pos, Size size) {
    ...
    switch (pos) {
      ...
      case "4":
        {
          Provider.of<Controller>(context, listen: false).setDate(s[0], "");
          print("gen condition------$gen_condition");
          Provider.of<Controller>(context, listen: false)
              .todaySales(s[0], " ", "");
                            ...
                            icon: new Icon(
                              ...
                              color: Provider.of<Controller>(context, listen: false)
                                      ...
                                      Provider.of<Controller>(context,
                                                  listen: false)
                                              .menu_index ==
                                          "4"||Provider.of<Controller>(context,
                                                  listen: false)
                                              .menu_index ==
                                          "5"
                                  ? P_Settings.wavecolor
